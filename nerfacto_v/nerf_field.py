...
class NerfField(Field):
    ...
    def __init__(
        ...
        print("field: view dependent is deactivated")
    ...
    def get_field_parameters_list(self):
        return (list(self.mlp_base.parameters()) + list(self.mlp_head.parameters()) + list(self.position_encoding.parameters()))
                # + list(self.direction_encoding.parameters())

    def get_embedding_parameters_list(self):
        if self.embedding_appearance is None:
            return []
        else:
            return list(self.embedding_appearance.parameters())
    ...
    def get_outputs(
        ...
        if self.embedding_appearance is not None:
            ...
            if camera_indices is not None:
                # print("Field: using camera_indices for embedding")
                ...
                if self.use_average_appearance_embedding:
                    ...
                    # print("Field: camera_indices is None, using zeros")
        ...
        outputs.update({FieldHeadNames.RGB: rgb,
                        "embedded_appearance": embedded_appearance})
