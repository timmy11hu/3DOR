...
from . import grid
class MLPWithDVGO(FieldComponent):
    ...
    def build_nn_modules(self) -> None:
        ...
        # )
        encoder = grid.create_grid('DenseGrid', channels=self.num_levels*self.features_per_level, world_size=[256] * 3, xyz_min=[0.] * 3, xyz_max=[1.] * 3)
        print(self.num_levels*self.features_per_level)
        mlp = MLP(
            in_dim=self.num_levels*self.features_per_level,
            num_layers=self.num_layers,
            layer_width=self.layer_width,
